...
# WRS FCSC Shelf config
shelf_width_cm = 90.0
shelf_depth_cm = 43.5

# shelfB
shelf_board_height_cm = 65.0

# shelfA
shelf_board_height_cm =124.0
shelf_stopper_height_cm = 3.5
ar_marker_thickness_cm = 0.0
...
x = -33
z = shelf_board_height_cm + shelf_stopper_height_cm - marker_size_cm / 2.0
